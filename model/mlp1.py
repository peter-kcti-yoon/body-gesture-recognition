...
class Model(nn.Module):
    def __init__(self, num_class, num_feature):
        ...
        self.layer1 = layer(num_feature, 330)
        self.layer2 = layer(330, 160,is_dropout=True)
        self.layer3 = layer(160, 80, is_dropout=True)
        self.layer4 = layer(80, 30, is_dropout=True)
